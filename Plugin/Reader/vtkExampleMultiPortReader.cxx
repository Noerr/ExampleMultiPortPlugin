#include "vtkExampleMultiPortReader.h"
...
vtkStandardNewMacro(vtkExampleMultiPortReader);
...
//------------------------------------------------------------------------------
vtkExampleMultiPortReader::vtkExampleMultiPortReader()
{
...
//------------------------------------------------------------------------------
void vtkExampleMultiPortReader::PrintSelf(ostream& os, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
int vtkExampleMultiPortReader::FillOutputPortInformation(int port, vtkInformation* info)
{
...
//------------------------------------------------------------------------------
int vtkExampleMultiPortReader::CanReadFile(const char* filename)
{
...
//------------------------------------------------------------------------------
bool vtkExampleMultiPortReader::ReadTimeValue(const char* filename, double& time)
{
...
//------------------------------------------------------------------------------
int vtkExampleMultiPortReader::RequestInformation(
...
//------------------------------------------------------------------------------
int vtkExampleMultiPortReader::RequestData(
  vtkInformation*, vtkInformationVector**, vtkInformationVector* outputVector)
{
  if (!this->FileName)
  {
...
//------------------------------------------------------------------------------
vtkSmartPointer<vtkDataObject> vtkExampleMultiPortReader::GenerateSquareMesh(double time)
{
...
//------------------------------------------------------------------------------
vtkSmartPointer<vtkDataObject> vtkExampleMultiPortReader::GenerateCircleMesh(double time)
{
  auto polyData = vtkSmartPointer<vtkPolyData>::New();
  auto points = vtkSmartPointer<vtkPoints>::New();
  auto cells = vtkSmartPointer<vtkCellArray>::New();
